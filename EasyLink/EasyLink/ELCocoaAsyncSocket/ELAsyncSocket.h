...
@class ELAsyncSocket;
@class ELAsyncReadPacket;
@class ELAsyncWritePacket;

extern NSString *const ELAsyncSocketException;
extern NSString *const ELAsyncSocketErrorDomain;
...
**/
- (NSRunLoop *)onSocket:(ELAsyncSocket *)sock wantsRunLoopForNewSocket:(ELAsyncSocket *)newSocket;
...
**/
- (BOOL)onSocketWillConnect:(ELAsyncSocket *)sock;
...
**/
- (void)onSocket:(ELAsyncSocket *)sock didReadPartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;
 ...
 * It may be used to for things such as updating progress bars.
**/
- (void)onSocket:(ELAsyncSocket *)sock didWritePartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;
...
**/
- (NSTimeInterval)onSocket:(ELAsyncSocket *)sock
...
**/
- (void)onSocketDidSecure:(ELAsyncSocket *)sock;
...
@interface ELAsyncSocket : NSObject
{
	...
	ELAsyncReadPacket *theCurrentRead;
	NSTimer *theReadTimer;
	NSMutableData *partialReadBuffer;
	
	NSMutableArray *theWriteQueue;
	ELAsyncWritePacket *theCurrentWrite;
