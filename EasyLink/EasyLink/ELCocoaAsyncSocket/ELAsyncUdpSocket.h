...
@class ELAsyncSendPacket;
@class ELAsyncReceivePacket;

extern NSString *const ELAsyncUdpSocketException;
extern NSString *const ELAsyncUdpSocketErrorDomain;
...
@interface ELAsyncUdpSocket : NSObject
{
	...
	ELAsyncSendPacket *theCurrentSend;
	NSTimer *theSendTimer;
	
	NSMutableArray *theReceiveQueue;
	ELAsyncReceivePacket *theCurrentReceive;
...
**/
- (BOOL)onUdpSocket:(ELAsyncUdpSocket *)sock
